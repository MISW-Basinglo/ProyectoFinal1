...
GMAIL_CREDENTIALS_PATH = os.getenv('GMAIL_CREDENTIALS_PATH', "credentials/mail_client.json")
GMAIL_TOKEN_PATH = os.getenv('GMAIL_TOKEN_PATH', "credentials/mail_client_credentials.json")
